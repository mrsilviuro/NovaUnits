...
extern bool isTimeMaster;        // true pe unitatea care a trimis sync (autoritatea de timp)
...
void loraSendGameReset();                                 // alerta joc nou (seq propriu)
